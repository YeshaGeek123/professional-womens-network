                            ...
                            <a href="<?php the_field('linkedin_link','options'); ?>" target="_blank" title="LinkedIn">
                                <span>
                                    <svg data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19">
                                        <g>
                                            <rect width="19" height="19" transform="translate(19 19) rotate(180)" fill="var(--white-color)" opacity="0"/>
                                            <path d="M13.945,8.4A4.629,4.629,0,0,0,9.3,13.021v4.669a.715.715,0,0,0,.715.715h1.667a.715.715,0,0,0,.715-.715V13.021A1.54,1.54,0,0,1,14.1,11.489a1.588,1.588,0,0,1,1.389,1.588v4.613a.715.715,0,0,0,.715.715h1.667a.715.715,0,0,0,.715-.715V13.021A4.629,4.629,0,0,0,13.945,8.4Z" transform="translate(-1.916 -1.731)" fill="var(--white-color)"/>
                                            <rect width="3.573" height="9.289" rx="0.9" transform="translate(2.382 7.384)" fill="var(--white-color)"/>
                                            <circle cx="1.786" cy="1.786" r="1.786" transform="translate(2.382 2.382)" fill="var(--white-color)"/>
                                        </g>
                                    </svg>
                                </span>
                            </a>
